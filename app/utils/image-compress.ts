// Ported from pi-web components/ChatInput.tsx 的压缩部分 — https://github.com/agegr/pi-web (MIT)
// 浏览器端图片压缩 只是体验优化 服务端边界校验才是安全线
// 大图压到 1024 边长 JPEG 0.85 压完反而更大时保留原图 GIF 不压 保动画
