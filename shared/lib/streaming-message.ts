// Ported from pi-web lib/streaming-message.ts — https://github.com/agegr/pi-web (MIT)
// 流式消息组装的纯函数 reducer 无任何框架依赖 Vue 中原样可用
// 状态只有 isStreaming 与 streamingMessage 按事件的 contentIndex 定位 content 块
// 逐块 start delta end
